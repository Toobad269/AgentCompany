...
function renderUploads() {
  ...
  const drop = `<div class="up-drop" id="up-drop"
      ...
      <div class="up-drop-text">Drop a file here or click</div>
      <div class="up-drop-sub">${u.path ? esc(u.path) : 'no active chat'}</div>
    </div>
  ...
  const list = u.files && u.files.length
    ...
    : empty('📎', 'No uploads', 'Upload through the field above or the 📎 button in chat');
