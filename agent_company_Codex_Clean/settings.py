...
PLAN_PROFILES = {
    "starter": {
        "label": "Starter",
        "description": "For simple solo chats and small local tasks.",
        "max_teams": 3,
        ...
        "highlights": [
            "Local chats",
            "Uploads and Obsidian",
            "PDF and ZIP tools",
        ],
    },
    "plus": {
        "label": "Plus",
        "description": "More research and project analysis for regular use.",
        "max_teams": 6,
        ...
        "highlights": [
            "Web research",
            "GitHub read access",
            "More teams and workers",
        ],
    },
    "studio": {
        "label": "Studio",
        "description": "Full beta features for the complete AgentCompany experience.",
        "max_teams": 8,
...
def save_subscription_plan(plan_name: str) -> None:
    ...
    if plan_name not in PLAN_PROFILES:
        raise ValueError("Unknown plan. Allowed: starter, plus, studio")
