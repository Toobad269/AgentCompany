...
## Neue Produktentscheidung: Website zuerst, keine Desktop-App fuer normale Nutzer

Feedback von Papa:

Eine Desktop-App koennte fuer normale Nutzer zu viel Reibung erzeugen. Besser waere eine Web-Plattform, in der der Nutzer direkt sieht, was AgentCompany baut.

Neue Richtung:

- keine Desktop-App als Hauptprodukt
- normale Nutzer arbeiten in der Website
- AgentCompany zeigt eine Live-Preview der erstellten Website oder Web-App
- der Nutzer kann direkt im Browser aendern lassen
- der Nutzer kann danach direkt eine Domain kaufen oder verbinden
- Hosting, Deployment und technische Einrichtung sollen automatisch passieren
- der Nutzer soll moeglichst nichts mehr selbst installieren oder konfigurieren muessen

Beispiel Burgerladen:

1. Nutzer beschreibt seinen Burgerladen.
2. AgentCompany erstellt Website oder Web-App.
3. Nutzer sieht sofort eine Preview.
4. Nutzer sagt per Chat: "Mach den Button groesser" oder "Fuege Lieferando hinzu".
5. AgentCompany aktualisiert die Preview.
6. Nutzer klickt auf "Publish".
7. Nutzer kauft oder verbindet eine Domain.
8. AgentCompany deployed automatisch.

Das ist fuer kleine Unternehmen deutlich einfacher als eine lokale App.

## Web-App als Hauptprodukt

Fuer normale Nutzer soll AgentCompany nicht wie ein kompliziertes Entwickler-Tool wirken.

Der Nutzer soll hauptsaechlich die Website benutzen:
...
AgentCompany sollte fuer normale Nutzer zuerst als Cloud-Webprodukt gebaut werden.
...
## Lokaler Runner nur optional spaeter

Eine Desktop-App oder ein lokaler Runner koennte spaeter optional fuer Spezialfaelle kommen, aber nicht als Hauptprodukt.
...
Diese Funktionen sind eher fuer technische Nutzer oder groessere Firmen relevant. Fuer die erste Produktidee ist wahrscheinlich besser:

- AgentCompany baut Websites/Web-Apps in Cloud-Workspaces
- Nutzer sieht Preview im Browser
- Deployment passiert automatisch
- Domain wird direkt gekauft oder verbunden
- Nutzer muss keinen Computer offen lassen

## Einfache Erklaerung fuer Nutzer

Der Nutzer muss AWS, Docker, DNS, Hosting oder Infrastruktur nicht verstehen.

In der App koennte einfach stehen:

- Diese Aufgabe laeuft in der Cloud.
- Deine Website ist bereit zur Vorschau.
- Deine Domain ist verbunden.
- Deine Website ist veroeffentlicht.
...
> Create websites, apps, and automations for your business. Preview them instantly and publish them with a domain in one place.
...
- Cloud-Webprodukt als Hauptoberflaeche
- Live-Preview fuer erstellte Websites und Web-Apps
- automatisches Publishing
- Domain direkt kaufen oder verbinden
- lokale App hoechstens spaeter optional fuer Spezialfaelle
